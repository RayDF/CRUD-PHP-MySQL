  ...
  <div class="card-body">
    <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" name="mata_kuliah" placeholder="Masukan Matkul" class="form-control">
      </div>
    
      <div class="form-group cols-sm-6">
        <label>Nama Materi</label>
        <input type="text" name="nama_materi" placeholder="Masukan Materi" class="form-control">
      </div>
     ...
     <div class="form-group cols-sm-6">
      ...
      <div class="form-group cols-sm-6">
        <input type="submit" value="Simpan" class="btn btn-success" button id="btn_simpan"> 
